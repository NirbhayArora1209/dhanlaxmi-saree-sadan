...
import { products, fabricOptions, occasionOptions, patternOptions, priceRanges, mockCategories } from '@/data/mockData';
...
export default function CategoryPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [products, currentCategory, searchQuery, filters]);
                  ...
                  <>
                    ...
                    <div className="mb-6 flex items-center justify-between">
                      <p className="text-gray-600">
                        Showing {sortedProducts.length} of {products.filter(p => p.category.toLowerCase() === currentCategory.name.toLowerCase()).length} products
                      </p>
                    </div>
